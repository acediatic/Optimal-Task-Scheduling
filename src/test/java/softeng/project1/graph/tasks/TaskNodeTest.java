...
class TaskNodeTest {
    ...
    void testIsFreeTrue() {
        ...
        OriginalTaskNodeState original = new OriginalTaskNodeState((short) 150,0, 0, childLinks, 0, 0);
    ...
    void testIsFreeFalse() {
        ...
        int[][] childLinks = new int[0][0];
        OriginalTaskNodeState original = new OriginalTaskNodeState((short) 150,0, 3, childLinks, 0, 0);
    ...
    void testTaskIDFalse() {
        int[] preReqs = new int[5];
        int[][] childLinks = new int[0][0];
        OriginalTaskNodeState original = new OriginalTaskNodeState((short) 420,0, 0, childLinks, 0, 0);
        ChangedTaskNodeState tNode = new ChangedTaskNodeState(original,3, preReqs);
    ...
    void testCopyAndSetPrerequisite() {
        ...
        int[][] childLinks = new int[0][0];
        OriginalTaskNodeState original = new OriginalTaskNodeState((short) 150,0, 1, childLinks, 0, 1);
    ...
    void testGetTaskCost() {
        int[] preReqs = new int[5];
        int[][] childLinks = new int[0][0];
        OriginalTaskNodeState original = new OriginalTaskNodeState((short) 150,10, 0, childLinks, 0, 0);
        ChangedTaskNodeState tNode = new ChangedTaskNodeState(original,0, preReqs);
    ...
    void testGetBottomLevel() {
        int[] preReqs = new int[5];
        int[][] childLinks = new int[0][0];
        OriginalTaskNodeState original = new OriginalTaskNodeState((short) 150,0, 0, childLinks, 500, 0);
        ChangedTaskNodeState tNode = new ChangedTaskNodeState(original,0, preReqs);
    ...
    void testGetProcessorPrerequisite() {
        int[] preReqs = new int[5];
        int[][] childLinks = new int[0][0];
        OriginalTaskNodeState original = new OriginalTaskNodeState((short) 150,0, 0, childLinks, 0, 3);
        ChangedTaskNodeState tNode = new ChangedTaskNodeState(original,0, preReqs);
    ...
    void testToString() {
        int[] preReqs = new int[5];
        int[][] childLinks = new int[2][2];
        OriginalTaskNodeState original = new OriginalTaskNodeState((short) 150,20, 2, childLinks, 10, 2);
        ChangedTaskNodeState tNode = new ChangedTaskNodeState(original,0, preReqs);
